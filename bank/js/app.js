 ...
 * POLIHOV DEV STUDIO
 * FILE: /bank/js/app.js
 * DESC: Логика приложения «Копилка»: рендер карточек, операции, сортировка, GitHub sync, модальные окна.
 */
...
// ====== SVG icons for buttons (sprite) ======
const ICONS = {
  plus:   `<svg class="icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/icons/sprite.svg#icon-plus"></use></svg>`,
  minus:  `<svg class="icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/icons/sprite.svg#icon-minus"></use></svg>`,
  pencil: `<svg class="icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/icons/sprite.svg#icon-pencil"></use></svg>`,
  trash:  `<svg class="icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/icons/sprite.svg#icon-trash"></use></svg>`,
  spinner:`<svg class="icon spin" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/icons/sprite.svg#icon-spinner"></use></svg>`,
  check:  `<svg class="icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/icons/sprite.svg#icon-check"></use></svg>`,
  clock:  `<svg class="icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/icons/sprite.svg#icon-clock"></use></svg>`
};
...
function renderList(){
  ...
  for(const b of filtered){
    ...
    card.innerHTML = `
      ...
      <div class="progressWrap ${goal ? "" : "is-dim"}">
